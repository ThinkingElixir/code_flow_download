defmodule CodeFlow.StreamsTest do
  @moduledoc """
  Fix or complete the code to make the tests pass.
  """
  use ExUnit.Case
  alias CodeFlow.Streams
  ...
  describe "order_total/1" do
    ...
    test "sums the total for all OrderItems in a list" do
      ...
      assert 136.25 == Streams.order_total(order_items)
    end
  end

  describe "count_active/1" do
    test "returns 0 for empty list" do
      assert 0 == Streams.count_active([])
    end
    ...
    test "returns correct count of active customers" do
      ...
      assert 3 == Streams.count_active(customers)
    end
  end
end
